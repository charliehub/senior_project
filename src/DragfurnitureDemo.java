...
public class DragfurnitureDemo extends JPanel {

  DTfurniture pic1, pic2, pic3, pic4, pic5, pic6, pic7, pic8, pic9, pic10,
      pic11, pic12;
   
  ArrayList<DTfurniture> pic = new ArrayList<DTfurniture>();
  
  static String mayaString = "akfurniture";

  static String anyaString = "englandfurniture";

  static String laineString = "livingroomfurniture";
  ...
  public DragfurnitureDemo() {
    super(new BorderLayout());
    picHandler = new furnitureTransferHandler();

    JPanel mugshots = new JPanel(new GridLayout(4, 3));
    pic1 = new DTfurniture(createImageIcon("/couches/" + mayaString + ".jpg",
        mayaString).getImage());
    pic1.setTransferHandler(picHandler);
    mugshots.add(pic1);
    pic2 = new DTfurniture(createImageIcon("/couches/" + anyaString + ".jpg",
        anyaString).getImage());
    pic2.setTransferHandler(picHandler);
    mugshots.add(pic2);
    pic3 = new DTfurniture(createImageIcon("/couches/" + laineString + ".jpg",
        laineString).getImage());
    pic3.setTransferHandler(picHandler);
    mugshots.add(pic3);
    
    pic4 = new DTfurniture(createImageIcon("/couches/" + cosmoString + ".jpg",
        cosmoString).getImage());
    pic4.setTransferHandler(picHandler);
    mugshots.add(pic4);
    pic5 = new DTfurniture(createImageIcon("/couches/" + adeleString + ".jpg",
        adeleString).getImage());
    pic5.setTransferHandler(picHandler);
    mugshots.add(pic5);
    pic6 = new DTfurniture(createImageIcon("/couches/" + alexiString + ".jpg",
  ...
  protected static ImageIcon createImageIcon(String path, String description) {
    java.net.URL imageURL = DragfurnitureDemo.class.getResource(path);
  ...
  public static void createAndShowGUI() {
    ...
    JFrame frame = new JFrame("DragfurnitureDemo");
    frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

    //Create and set up the menu bar and content pane.
    DragfurnitureDemo demo = new DragfurnitureDemo();
...
/*
 * furnitureTransferHandler.java is used by the 1.4 DragfurnitureDemo.java example.
 */
...
/*
 * DTfurniture.java is used by the 1.4 DragfurnitureDemo.java example.
 */
...
class DTfurniture extends furniture implements MouseMotionListener {
  ...
  public DTfurniture(Image image) {
    ...
    //DragfurnitureDemo does not use menu accelerators and, since
    //the default value of installInputMapBindings is true,
    //the bindings are installed. DragfurnitureDemo2 does use
  ...
  //This method is necessary because DragfurnitureDemo and
  //DragfurnitureDemo2 both use this class and DragfurnitureDemo
  //needs to have the input map bindings installed for
  //cut/copy/paste. DragfurnitureDemo2 uses menu accelerators
...
/*
 * furniture.java is used by the 1.4 TrackFocusDemo.java and DragfurnitureDemo.java
 * examples.
 */
