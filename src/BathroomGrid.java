...
public class BathroomGrid extends JPanel {
  ...
  BathroomsTransferHandler picHandler;
  ...
  public BathroomGrid() {
    ...
    //drop targets.
    pic7 = new DTBathrooms(null);
    pic7.setTransferHandler(picHandler);
    mugshots.add(pic7);
    pic8 = new DTBathrooms(null);
    pic8.setTransferHandler(picHandler);
    mugshots.add(pic8);
    pic9 = new DTBathrooms(null);
    ...
    color = new JSlider();
    mugshots.add(color);
    //pic10 = new DTBathrooms(null);
    //pic10.setTransferHandler(picHandler);
    //mugshots.add(pic10);
    //pic11 = new DTBathrooms(null);
    //pic11.setTransferHandler(picHandler);
    //mugshots.add(pic11);
    //pic12 = new DTBathrooms(null);
  ...
  protected static ImageIcon createImageIcon(String path, String description) {
    java.net.URL imageURL = Bathrooms.class.getResource(path);
  ...
  public static void createAndShowGUI() {
    ...
    JFrame frame = new JFrame("Bathrooms");
    frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

    //Create and set up the menu bar and content pane.
    BathroomGrid demo = new BathroomGrid();
...
class BathroomsTransferHandler extends TransferHandler {
  ...
  protected Transferable createTransferable(JComponent c) {
    sourcePic = (DTBathrooms) c;
    shouldRemove = true;
    return new BathroomsTransferHandler.BathroomsTransferable(sourcePic);
  }
  ...
  class BathroomsTransferable implements Transferable {
    private Image image;

    BathroomsTransferable(DTBathrooms pic) {
      image = pic.image;
    }
...
class DTBathrooms extends Bathrooms implements MouseMotionListener {
  private MouseEvent firstMouseEvent = null;

  private static boolean installInputMapBindings = true;

  public DTBathrooms(Image image) {
    super(image);
