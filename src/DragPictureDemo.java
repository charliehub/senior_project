...
public class DragPictureDemo extends JPanel {
  ...
  static String mayaString = "strawberry";

  static String anyaString = "floorplan";

  static String laineString = "Bathroom1";

  static String cosmoString = "freedesign";

  static String adeleString = "livingroom";

  static String alexiString = "marble";
   ...
   */
   public  static void createAndShowGUI() {
    ...
    public void stateChanged2(ChangeEvent ce) {
        Image image = null;
       JSlider source2 = (JSlider)ce.getSource();
        if (!source2.getValueIsAdjusting()) {
             fps = 2 * (int)source2.getValue();
    ...
    public void stateChanged(ChangeEvent ce) {
       ...
       JSlider source = (JSlider)ce.getSource();
        if (!source.getValueIsAdjusting()) {
             fps = 2 * (int)source.getValue();
                int newheight = 1000 / fps;
...
class Picture extends JComponent implements MouseListener, FocusListener,
  ...
  protected void paintComponent(Graphics graphics) {
    ...
    g.fillRect(0, 0, image == null ? fps : image.getWidth(this),
        image == null ? fps : image.getHeight(this));
