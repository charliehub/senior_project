...
public class DragdecorDemo extends JPanel {
  ...
  protected static ImageIcon createImageIcon(String path, String description) {
    java.net.URL imageURL = DragdecorDemo.class.getResource(path);
  ...
  public static void createAndShowGUI() {
    ...
    DragdecorDemo demo = new DragdecorDemo();
