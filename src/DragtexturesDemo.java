...
public class DragtexturesDemo extends JPanel {
  ...
  protected static ImageIcon createImageIcon(String path, String description) {
    java.net.URL imageURL = DragtexturesDemo.class.getResource(path);
  ...
  public static void createAndShowGUI() {
    ...
    JFrame frame = new JFrame("DragtexturesDemo");
    frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

    //Create and set up the menu bar and content pane.
    DragtexturesDemo demo = new DragtexturesDemo();
...
/*
 * texturesTransferHandler.java is used by the 1.4 DragtexturesDemo.java example.
 */
...
/*
 * DTtextures.java is used by the 1.4 DragtexturesDemo.java example.
 */
...
class DTtextures extends textures implements MouseMotionListener {
  ...
  public DTtextures(Image image) {
    ...
    //DragtexturesDemo does not use menu accelerators and, since
    //the default value of installInputMapBindings is true,
    //the bindings are installed. DragtexturesDemo2 does use
  ...
  //This method is necessary because DragtexturesDemo and
  //DragtexturesDemo2 both use this class and DragtexturesDemo
  //needs to have the input map bindings installed for
  //cut/copy/paste. DragtexturesDemo2 uses menu accelerators
...
/*
 * textures.java is used by the 1.4 TrackFocusDemo.java and DragtexturesDemo.java
 * examples.
 */
